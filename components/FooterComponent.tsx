...
export const FooterComponent = () => {
  ...
  const isContactPage = pathname === '/conoceme'
      ...
      {!isContactPage && (
        <div className="flex flex-col lg:flex-row gap-1 lg:gap-8 justify-center">
          <div className="flex gap-1 justify-center">
            <Image src={wtsp} alt="whatsapp" width={16} height={12} />
            <p className="text-default-500">+569 64562423</p>
          </div>
          <div className="flex gap-1 justify-center">
            <Image src={email} alt="email" width={16} height={12} />
            <p className="text-default-500">contacto@lorenasoto.cl</p>
          </div>
          <div className="flex gap-1 justify-center">
            <Image src={location} alt="location" width={16} height={12} />
